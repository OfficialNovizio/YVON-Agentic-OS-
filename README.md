...
- `graph/` — full graphify output (11535 nodes, 21418 edges, 1069 communities) — see `graph/graph.html` for the interactive visualization, `graph/GRAPH_REPORT.md` for the human-readable summary
- `knowledge/` — semantic knowledge extracted from this repo (MemPalace)

Last built: 2026-09-02T01:22:27Z
