...
- `graph/` — full graphify output (11351 nodes, 21272 edges, 985 communities) — see `graph/graph.html` for the interactive visualization, `graph/GRAPH_REPORT.md` for the human-readable summary
- `knowledge/` — semantic knowledge extracted from this repo (MemPalace)

Last built: 2026-08-26T19:46:23Z
