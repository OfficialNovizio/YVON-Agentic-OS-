...
- `graph/` — full graphify output (12065 nodes, 21923 edges, 1201 communities) — see `graph/graph.html` for the interactive visualization, `graph/GRAPH_REPORT.md` for the human-readable summary
- `knowledge/` — semantic knowledge extracted from this repo (MemPalace)

Last built: 2026-09-10T01:21:50Z
