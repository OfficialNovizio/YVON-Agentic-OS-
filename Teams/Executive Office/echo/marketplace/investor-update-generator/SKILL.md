...
source: https://skillsmp.com/creators/borghei/claude-skills/personal-productivity-investor-update-generator
source_repo: https://github.com/borghei/Claude-Skills/tree/main/personal-productivity/investor-update-generator
author: borghei
copied_verbatim: true
fulfills_catalog_entry: investor-update-best-practices (VYON_Skills_Catalog_Full_v2.html, echo/Executive Office)
...
<!--
  Unmodified copy of the "investor-update-generator" skill, selected to fulfill the catalog's
  "investor-update-best-practices" slot — it validates a draft update against a rubric of what
  makes updates work, which matches "industry norms for cadence, metrics selection, and ask
  formulation" more precisely than the many investor-update *writer* skills also found during
  research (those write updates directly, which is closer to a future custom
  investor-update-template skill, not this best-practices/norms slot).
  All four files (SKILL.md + scripts/ + assets/ + references/) copied in full per project workflow.
-->
