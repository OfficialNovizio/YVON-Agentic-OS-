...
source: https://github.com/anthropics/knowledge-work-plugins/tree/main/small-business/skills/close-month
source_raw: https://raw.githubusercontent.com/anthropics/knowledge-work-plugins/main/small-business/skills/close-month/SKILL.md
source_repo: anthropics/knowledge-work-plugins
author: anthropics (Anthropic PBC)
fulfills_catalog_entry: chart-of-accounts / bookkeeping (Finance & Treasury · ledger · Bookkeeping)
...
<!--
YVON selection rationale — reconciles QB vs payment processors, flags gaps
(unmatched settlements / unmatched QB deposits / variance lines), surfaces
suspicious duplicates + missing receipts, writes plain-English P&L narrative,
exports auditable close packet. Approval-gate discipline: never auto-fix, never
auto-delete. Portable — no plugin-config path.
-->
