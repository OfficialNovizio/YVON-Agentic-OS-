...
| experiment-instrumentation | file read (Shared OS/logical/sample_size.py — stdlib, no network)**; handoff channel to Engineering (instrumentation requests, echo-confirmed) | pre-flight verification + sizing/significance |
