...
source: https://github.com/anthropics/claude-for-legal/tree/main/ip-legal/skills/clearance
source_raw: https://raw.githubusercontent.com/anthropics/claude-for-legal/main/ip-legal/skills/clearance/SKILL.md
source_repo: anthropics/claude-for-legal
author: anthropics (Anthropic PBC)
fulfills_catalog_entry: trademark-search (Legal & Compliance · guard · IP Protection)
...
Selected 2026-07-29 as guard's trademark clearance skill.

Why:
- "This skill never concludes a mark is clear" — loudest guardrail, matches §0.5/§0.7.
- Adjacent-families sweep + non-Latin transliteration + translation equivalents
  kill the "cleared in English then sued in French" mode.
- Jurisdiction-specific confusion frameworks (US du Pont/Polaroid/Sleekcraft; EU
  Art. 8(1)(b) EUTMR; UK TMA 1994 §5(2)) — refuses to apply US doctrine silently.
- Every search result carries provenance tags; no invention.

Fragment note: config path `~/.claude/plugins/config/claude-for-legal/ip-legal/CLAUDE.md`
is shared by all 3 marketplace skills adopted by guard. ONE custom wrapper —
`guard/custom/ip-routing` — binds the YVON config layer for all three.
-->
