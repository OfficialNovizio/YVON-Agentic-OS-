...
source: https://skillsmp.com/creators/marvinrichter/clarc/skills-layout-composition
source_repo: https://github.com/marvinrichter/clarc/tree/main/skills/layout-composition
author: marvinrichter
copied_verbatim: true
fulfills_catalog_entry: canvas-design (VYON_Skills_Catalog_Full_v2.html, atlas/Brand Studio)
...
<!--
  Unmodified copy of "layout-composition", selected to fulfill the catalog's "canvas-design"
  slot — composition and layout craft. Matches the catalog protocol nearly verbatim
  ("Grid + hierarchy first / Contrast for focal point / Whitespace as element" → this skill's
  grid systems, visual-hierarchy priority ordering, and active-whitespace sections).
  Chosen over ArnavPuri/designskills (web-implementation-leaning) and atelier-layout
  (CSS-implementation-heavy) because this one is framed for making layout DECISIONS,
  which is atlas's altitude — the CSS snippets it carries are illustrations, usable when
  the deliverable is web, ignorable when it's a social graphic or deck.
-->
