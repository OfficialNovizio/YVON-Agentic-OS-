...
function getConfig() {
    ...
    return {
        ...
        graphifyGraphJson: fromRoot(fileConfig.graphifyGraphJson) ?? (0, path_1.join)(root, 'graphify-out', 'graph.json'),
        ...
        sessionMemoryDir: fromRoot(fileConfig.sessionMemoryDir) ?? (0, path_1.join)(root, 'store', 'sessions'),
