...
exports.resolveRetrievalShape = resolveRetrievalShape;
const RETRIEVAL_SHAPES = {
    SHALLOW_LOOKUP: {
        topK: 5,
...
function resolveRetrievalShape(archetype) {
    return RETRIEVAL_SHAPES[archetype];
}
//# sourceMappingURL=retrieval-shape.js.map