export type TaskType = 'engineering' | 'strategy' | 'governance' | 'brand_marketing' | 'cybersecurity' | 'product_analytics' | 'ai_agents' | 'general';
export type KnowledgeSource = 'graphify' | 'codegraph' | 'agent_memory' | 'hermes_memory' | 'project_docs' | 'venture_context' | 'session_state' | 'shared_os_logical' | 'team_workflows' | 'rag_bridge' | 'toon_context';
