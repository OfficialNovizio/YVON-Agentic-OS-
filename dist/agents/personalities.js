...
exports.DEPARTMENT_COUNT = exports.AGENT_COUNT = exports.AGENT_REGISTRY = void 0;
exports.getAgentProfile = getAgentProfile;
exports.getDepartmentAgents = getDepartmentAgents;
exports.getDepartmentLeader = getDepartmentLeader;
...
function getAgentProfile(id) {
    ...
    return exports.AGENT_REGISTRY.find((p) => p.shortId === lower || p.name.toLowerCase() === lower);
}
/** Get all agents in a department */
function getDepartmentAgents(department) {
    return exports.AGENT_REGISTRY.filter(p => p.department === department);
}
/** Get the department leader */
function getDepartmentLeader(department) {
    return exports.AGENT_REGISTRY.find(p => p.department === department && p.isLeader);
}
/** Get all department leaders */
function getLeaders() {
    return exports.AGENT_REGISTRY.filter(p => p.isLeader);
}
/** List all departments */
function getDepartments() {
    return [...new Set(exports.AGENT_REGISTRY.map(p => p.department))];
}
/**
...
exports.AGENT_COUNT = exports.AGENT_REGISTRY.length;
/** Count of departments */
exports.DEPARTMENT_COUNT = getDepartments().length;
