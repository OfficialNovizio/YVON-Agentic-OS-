...
tier: 2
description: |
  Choose the grid based on the content… (yvon)
triggers:
  - layout composition
allowed-tools: []
...
identity: none
provenance:
  source_file: Teams/Brand Studio/atlas/marketplace/layout-composition/SKILL.md
  source_hash: 3e6f8291979fc6f213e2f44c5ea8da0c7145b2231333b73e0ec490a1173bcfc3
  generated: 2026-07-20T03:20:23.529Z
  generator: cli/skillgen.js
portable: true
---
<!-- AUTO-GENERATED from Teams/Brand Studio/atlas/marketplace/layout-composition/SKILL.md — DO NOT EDIT.
...
echo "OPERATING AS: atlas — Brand Studio · skill: layout-composition"
echo "REPO_ROOT: $_ROOT"
_BRANCH=$(git -C "$_ROOT" branch --show-current 2>/dev/null || echo unknown)
echo "BRANCH: $_BRANCH"
mkdir -p "$_ROOT/store/telemetry" 2>/dev/null || true
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"atlas\",\"skill\":\"layout-composition\",\"branch\":\"$_BRANCH\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
```
...
Use when the request matches: "layout composition".
...
_ROOT=$(pwd); while [ "$_ROOT" != "/" ] && [ ! -d "$_ROOT/Teams" ]; do _ROOT=$(dirname "$_ROOT"); done
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"atlas\",\"skill\":\"layout-composition\",\"event\":\"complete\",\"outcome\":\"$_OUTCOME\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
```
