...
tier: 3
description: |
  Catalogued nudge patterns — defaults · social proof · loss aversion framing · commitment · anchoring · scarcity. Each pattern cites peer-reviewed source. Ethics-tagged; deployment via ethics-review. (yvon)
triggers:
  - nudge library
allowed-tools:
  - Read
...
provenance:
  source_file: Teams/Behavioural Science/nudge/custom/nudge-library/SKILL.md
  source_hash: cbb6ec16bb059c8389f7eaa1a6c1e5dc8b052aa6b8015a0d8d7897038e3eee6d
  generated: 2026-08-08T17:13:12.616Z
  generator: cli/skillgen.js
portable: true
---
<!-- AUTO-GENERATED from Teams/Behavioural Science/nudge/custom/nudge-library/SKILL.md — DO NOT EDIT.
...
echo "OPERATING AS: nudge — Behavioural Science · skill: nudge-library"
echo "REPO_ROOT: $_ROOT"
_BRANCH=$(git -C "$_ROOT" branch --show-current 2>/dev/null || echo unknown)
echo "BRANCH: $_BRANCH"
mkdir -p "$_ROOT/store/telemetry" 2>/dev/null || true
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"nudge\",\"skill\":\"nudge-library\",\"branch\":\"$_BRANCH\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
...
_ROOT=$(pwd); while [ "$_ROOT" != "/" ] && [ ! -d "$_ROOT/Teams" ]; do _ROOT=$(dirname "$_ROOT"); done
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"nudge\",\"skill\":\"nudge-library\",\"event\":\"complete\",\"outcome\":\"$_OUTCOME\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
```
