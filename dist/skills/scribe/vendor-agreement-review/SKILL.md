...
identity: none
provenance:
  source_file: Teams/Legal & Compliance/scribe/marketplace/vendor-agreement-review/SKILL.md
  source_hash: 195b12d29304d84c9cecdb761d8cdf802fca09a73432382a9b92b450489aa2b3
  generated: 2026-07-29T22:02:08.738Z
  generator: cli/skillgen.js
portable: true
---
<!-- AUTO-GENERATED from Teams/Legal & Compliance/scribe/marketplace/vendor-agreement-review/SKILL.md — DO NOT EDIT.
...
echo "OPERATING AS: scribe — Legal & Compliance · skill: vendor-agreement-review"
echo "REPO_ROOT: $_ROOT"
_BRANCH=$(git -C "$_ROOT" branch --show-current 2>/dev/null || echo unknown)
echo "BRANCH: $_BRANCH"
mkdir -p "$_ROOT/store/telemetry" 2>/dev/null || true
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"scribe\",\"skill\":\"vendor-agreement-review\",\"branch\":\"$_BRANCH\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
```
...
Use when the request matches: "vendor agreement review".
...
_ROOT=$(pwd); while [ "$_ROOT" != "/" ] && [ ! -d "$_ROOT/Teams" ]; do _ROOT=$(dirname "$_ROOT"); done
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"scribe\",\"skill\":\"vendor-agreement-review\",\"event\":\"complete\",\"outcome\":\"$_OUTCOME\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
```
