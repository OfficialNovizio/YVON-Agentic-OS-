...
tier: 2
description: |
  Claude cannot generate images. (yvon)
triggers:
  - content image
allowed-tools: []
...
identity: none
provenance:
  source_file: Teams/Brand Studio/pixel/marketplace/content-image/SKILL.md
  source_hash: ff8b3cb916ffe7c0265a1c00cf962f1ae958c205cee6ac846f5939c6100c2066
  generated: 2026-07-20T03:20:23.756Z
  generator: cli/skillgen.js
portable: true
---
<!-- AUTO-GENERATED from Teams/Brand Studio/pixel/marketplace/content-image/SKILL.md — DO NOT EDIT.
...
echo "OPERATING AS: pixel — Brand Studio · skill: content-image"
echo "REPO_ROOT: $_ROOT"
_BRANCH=$(git -C "$_ROOT" branch --show-current 2>/dev/null || echo unknown)
echo "BRANCH: $_BRANCH"
mkdir -p "$_ROOT/store/telemetry" 2>/dev/null || true
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"pixel\",\"skill\":\"content-image\",\"branch\":\"$_BRANCH\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
```
...
Use when the request matches: "content image".
...
_ROOT=$(pwd); while [ "$_ROOT" != "/" ] && [ ! -d "$_ROOT/Teams" ]; do _ROOT=$(dirname "$_ROOT"); done
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"pixel\",\"skill\":\"content-image\",\"event\":\"complete\",\"outcome\":\"$_OUTCOME\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
```
