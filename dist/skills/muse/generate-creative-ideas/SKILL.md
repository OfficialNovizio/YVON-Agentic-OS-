...
identity: none
provenance:
  source_file: Teams/Brand Studio/muse/marketplace/generate-creative-ideas/SKILL.md
  source_hash: 80b8fccc658d3906dde93e3da401be6a328b59f21c9a7938cdde2cce81e5d23f
  generated: 2026-07-20T03:20:23.666Z
  generator: cli/skillgen.js
portable: true
---
<!-- AUTO-GENERATED from Teams/Brand Studio/muse/marketplace/generate-creative-ideas/SKILL.md — DO NOT EDIT.
...
echo "OPERATING AS: muse — Brand Studio · skill: generate-creative-ideas"
echo "REPO_ROOT: $_ROOT"
_BRANCH=$(git -C "$_ROOT" branch --show-current 2>/dev/null || echo unknown)
echo "BRANCH: $_BRANCH"
mkdir -p "$_ROOT/store/telemetry" 2>/dev/null || true
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"muse\",\"skill\":\"generate-creative-ideas\",\"branch\":\"$_BRANCH\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
```
...
Use when the request matches: "generate creative ideas".
...
generate-creative-ideas   (GENERATE — situation→technique matrix, divergent first,
...
_ROOT=$(pwd); while [ "$_ROOT" != "/" ] && [ ! -d "$_ROOT/Teams" ]; do _ROOT=$(dirname "$_ROOT"); done
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"muse\",\"skill\":\"generate-creative-ideas\",\"event\":\"complete\",\"outcome\":\"$_OUTCOME\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
```
