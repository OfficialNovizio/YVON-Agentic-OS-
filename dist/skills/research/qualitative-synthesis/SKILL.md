...
tier: 3
description: |
  Cross-project qualitative synthesis — themes across multiple studies, longitudinal patterns, narrative arcs. Uses grounded-theory coding; every synthesised theme traces to source studies. (yvon)
triggers:
...
identity: none
provenance:
  source_file: Teams/Market Intelligence/research/custom/qualitative-synthesis/SKILL.md
  source_hash: e928f4bf9cd9288eb09b2ebed9f6b300a664113e42dad24aef5d064d64b1d888
  generated: 2026-08-08T16:51:52.818Z
  generator: cli/skillgen.js
portable: true
---
<!-- AUTO-GENERATED from Teams/Market Intelligence/research/custom/qualitative-synthesis/SKILL.md — DO NOT EDIT.
...
echo "OPERATING AS: research — Market Intelligence · skill: qualitative-synthesis"
echo "REPO_ROOT: $_ROOT"
_BRANCH=$(git -C "$_ROOT" branch --show-current 2>/dev/null || echo unknown)
echo "BRANCH: $_BRANCH"
mkdir -p "$_ROOT/store/telemetry" 2>/dev/null || true
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"research\",\"skill\":\"qualitative-synthesis\",\"branch\":\"$_BRANCH\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
...
_ROOT=$(pwd); while [ "$_ROOT" != "/" ] && [ ! -d "$_ROOT/Teams" ]; do _ROOT=$(dirname "$_ROOT"); done
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"research\",\"skill\":\"qualitative-synthesis\",\"event\":\"complete\",\"outcome\":\"$_OUTCOME\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
```
