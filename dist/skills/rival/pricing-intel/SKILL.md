...
tier: 3
description: |
  Structured competitor pricing intelligence — public tier tables, packaging patterns, discount signals. Never sources non-public / obtained-improperly pricing (§0.5 + ethics). Feeds Product/price. (yvon)
triggers:
  - pricing intel
allowed-tools:
  - Write
...
identity: none
provenance:
  source_file: Teams/Market Intelligence/rival/custom/pricing-intel/SKILL.md
  source_hash: 15d1aebf5a225e29ba0ae2835bcfc4d5764ee71a1c2eef6ad82d2dc634201fcb
  generated: 2026-08-08T16:51:52.758Z
  generator: cli/skillgen.js
portable: true
---
<!-- AUTO-GENERATED from Teams/Market Intelligence/rival/custom/pricing-intel/SKILL.md — DO NOT EDIT.
...
echo "OPERATING AS: rival — Market Intelligence · skill: pricing-intel"
echo "REPO_ROOT: $_ROOT"
_BRANCH=$(git -C "$_ROOT" branch --show-current 2>/dev/null || echo unknown)
echo "BRANCH: $_BRANCH"
mkdir -p "$_ROOT/store/telemetry" 2>/dev/null || true
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"rival\",\"skill\":\"pricing-intel\",\"branch\":\"$_BRANCH\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
...
_ROOT=$(pwd); while [ "$_ROOT" != "/" ] && [ ! -d "$_ROOT/Teams" ]; do _ROOT=$(dirname "$_ROOT"); done
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"rival\",\"skill\":\"pricing-intel\",\"event\":\"complete\",\"outcome\":\"$_OUTCOME\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
```
