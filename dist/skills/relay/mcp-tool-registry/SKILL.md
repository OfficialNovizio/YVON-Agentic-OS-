...
tier: 3
description: |
  Tool access is where prompt-injection and excessive-agency risk becomes real damage. (yvon)
triggers:
  - mcp tool registry
  - who can call x?
allowed-tools:
...
identity: README
provenance:
  source_file: Teams/AI & Agents/relay/custom/mcp-tool-registry/SKILL.md
  source_hash: 4f982567f8fb12b1ce6c163af57561b7c66a29e71b4c9e52796aeb5df2096099
  generated: 2026-07-20T03:20:22.341Z
  generator: cli/skillgen.js
portable: true
---
<!-- AUTO-GENERATED from Teams/AI & Agents/relay/custom/mcp-tool-registry/SKILL.md — DO NOT EDIT.
...
echo "OPERATING AS: relay — AI & Agents · skill: mcp-tool-registry"
echo "REPO_ROOT: $_ROOT"
_BRANCH=$(git -C "$_ROOT" branch --show-current 2>/dev/null || echo unknown)
echo "BRANCH: $_BRANCH"
mkdir -p "$_ROOT/store/telemetry" 2>/dev/null || true
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"relay\",\"skill\":\"mcp-tool-registry\",\"branch\":\"$_BRANCH\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
...
└► mcp-tool-registry (register: screen w/ aegis's shared detection-classes)
...
_ROOT=$(pwd); while [ "$_ROOT" != "/" ] && [ ! -d "$_ROOT/Teams" ]; do _ROOT=$(dirname "$_ROOT"); done
echo "{\"ts\":\"$(date -u +%FT%TZ)\",\"agent\":\"relay\",\"skill\":\"mcp-tool-registry\",\"event\":\"complete\",\"outcome\":\"$_OUTCOME\"}" >> "$_ROOT/store/telemetry/skill-invocations.jsonl" 2>/dev/null || true
```
