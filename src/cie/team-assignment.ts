...
export function resolveOwnerFromPath(sourceFile: string | undefined): OwnerInfo | null {
...
export function resolveTeam(entity: string, scope?: string): TeamAssignmentResult {
  const resolution = resolveEntity(entity, scope)
